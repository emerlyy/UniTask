...
const styles = StyleSheet.create({
  ...
  heroSub: { color: "#E7F0FF", fontWeight: "700", fontSize: 12 },
  heroDeadline: { color: theme.white, fontWeight: "800" },
  scoreBadgeLarge: { backgroundColor: "rgba(255,255,255,0.15)", borderWidth: 1, borderColor: "rgba(255,255,255,0.25)", paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, alignItems: "center" },
  scoreValue: { color: theme.white, fontSize: 20, fontWeight: "900", lineHeight: 22 },
  scoreSuffix: { color: "#E7F0FF", fontWeight: "700" },
  ...
  progressLabel: { color: "#6b7280", fontWeight: "700" },
  progressValue: { color: "#111827", fontWeight: "800" },
  ...
  progressFootText: { color: "#6b7280", fontSize: 12 },
  ...
  kv: { color: "#4b5563" },
  kvValue: { color: "#111827", fontWeight: "700" },
  ...
  kvKey: { color: "#6b7280", fontSize: 12, marginBottom: 6 },
  kvVal: { color: "#111827", fontWeight: "700" },
  ...
  footerTitle: { fontWeight: "800", color: "#111827" },
});
